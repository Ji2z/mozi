...
class FeatureExtractor:
  ...
  def _build_detection_model(self):
      ...
      cfg.merge_from_file('C:/Users\multicampus\Desktop\싸피/2차프로젝트/SubPJT1/skeleton-project/speak_image/IC/model_data/detectron_model.yaml')
      cfg.freeze()

      model = build_detection_model(cfg)
      # detectron_model.pth의 주소
      checkpoint = torch.load('C:/Users\multicampus\Desktop\싸피/2차프로젝트/SubPJT1/checkpoints/detectron_model.pth',
...
class Caption_Model:
    ...
    def load_model(self):
        ...
        infos = captioning.utils.misc.pickle_load(open('C:/Users\multicampus\Desktop\싸피/2차프로젝트/SubPJT1//checkpoints/infos_trans12-best.pkl', 'rb'))
        infos['opt'].vocab = infos['vocab']
    
        self.model = captioning.models.setup(infos['opt'])
        self.model.cuda()
        self.model.load_state_dict(torch.load('C:/Users\multicampus\Desktop\싸피/2차프로젝트/SubPJT1//checkpoints/model-best.pth'))
